...
void Sprite::DrawScaled(int a_X, int a_Y, int a_Width, int a_Height, bool is_flipped, Surface* a_Target)
{
	...
	// If negative a_X or a_Y, find offset for source buffer.
	...
	int width{ x2 - x1 };
	int height{ y2 - y1 };
	int flip_offset{ is_flipped ? width - 1 : 0 };
